    ...
    def __init__(
        ...
        if self.num_classes > 0:
            self.label_emb = nn.Embedding(
                num_classes + int(self.drop_label_prob > 0), 
                time_embed_dim)
...
# Define UNet model variants of different sizes
...
def ADM_32(num_classes=10, in_channels=3, dropout=0, learn_sigma=False, class_cond=True, drop_label_prob=0.0, **kwargs):
    return create_unet_model(image_size=32, num_channels=128, num_res_blocks=3, attention_resolutions="16,8", num_heads=1, 
                             num_head_channels=32, num_classes=num_classes, dropout=dropout, in_channels=in_channels, 
                             drop_label_prob=drop_label_prob, learn_sigma=learn_sigma, class_cond=class_cond, **kwargs)

def ADM_64(num_classes=10, in_channels=3, dropout=0, learn_sigma=False, class_cond=True, drop_label_prob=0.0, **kwargs):
    return create_unet_model(image_size=64, num_channels=192, num_res_blocks=3, attention_resolutions="32,16,8", num_heads=1, 
...
def ADM_256(num_classes=10, in_channels=3, dropout=0, learn_sigma=False, class_cond=True, drop_label_prob=0.0, **kwargs):
    return create_unet_model(image_size=256, num_channels=256, num_res_blocks=2, attention_resolutions="32,16,8", num_heads=1, 
                             num_head_channels=64, num_classes=num_classes, dropout=dropout, in_channels=in_channels, 
                             drop_label_prob=drop_label_prob, learn_sigma=learn_sigma, class_cond=class_cond, **kwargs)

def ADM_512(num_classes=10, in_channels=3, dropout=0, learn_sigma=False, class_cond=True, drop_label_prob=0.0, **kwargs):
    return create_unet_model(image_size=512, num_channels=256, num_res_blocks=2, attention_resolutions="32,16,8", num_heads=1, 
                             num_head_channels=64, num_classes=num_classes, dropout=dropout, in_channels=in_channels, 
                             drop_label_prob=drop_label_prob, learn_sigma=learn_sigma, class_cond=class_cond, **kwargs)
...
def LDM(num_classes=10, in_channels=4, dropout=0, learn_sigma=False, class_cond=True, drop_label_prob=0.0, **kwargs):
    return create_unet_model(image_size=32, num_channels=256,  num_res_blocks=2, attention_resolutions="32,16,8",  num_heads=1, 
                             channel_mult="1,2,4", num_head_channels=32, num_classes=num_classes, dropout=dropout, in_channels=in_channels,  
                             learn_sigma=learn_sigma, class_cond=class_cond, drop_label_prob=drop_label_prob, **kwargs)
...
if __name__ == '__main__':
    unet_model = ADM_32(num_classes=1000).cuda()
