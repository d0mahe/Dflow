...
def parse_args():
    ...
    parser.add_argument("--ref_batch", type=str, default='./reference_batches/VIRTUAL_imagenet256_labeled.npz', help="FID cache")
...
def build_model(args):
    ...
    model = model_dict[args.model](image_size=args.image_size, patch_size=args.patch_size,
                                    in_channels=args.in_chans, num_classes=args.num_classes,
                                    flow_ratio=args.flow_ratio, class_dropout_prob=args.drop_label_prob)
    return model
